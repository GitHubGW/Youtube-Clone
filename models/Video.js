  ...
  comments: [
    {
      ...
      // 즉 아래 type: mongoose.Schema.Types.ObjectId는 type: Comment._id와 같은 의미라고 보면 된다. (확실하진 않음)
...
// mongoose.model("Video", VideoSchema): 몽구스를 이용해서 Video모델을 만들고 그 Video모델의 스키마는 VideoSchema로 설정함 
